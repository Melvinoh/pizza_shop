    ...
    <section class="blogs">
        <div class="prod-blog">
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="review">
                                <img src="./pictures/people4.jpeg" alt="img">
                                <div class="content">
            ...
            <div class="comments-con">
                ...
                <div class="comment-wrapper">
                    <div class="comment">
                        <img src="./pictures/person5.webp" alt="img">
                        <div class="conent">
                            <div class="head">
                                <h3>brian kanoti</h3>
        ...
        <div class="prod-sidebar">
            ...
            <div class="relatedpost-con">
                ...
                <div class="rpwrap">
                    <div class="post">
                        <img src="./pictures/pizzachoma.jpeg" alt="">
                        <div class="cont">
                            <h3>sweet pizza choma</h3>
                            <div class="det">
